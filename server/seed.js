  ...
  try {
    ...
    for (const [index, user] of users.entries()) {
      ...
      for (let j = 1; j <= 7; j++) {
        ...
        //const uploadTime = faker.date.past()
...
//   const randomString = faker.random.alphaNumeric(50);
...
//       const displayname = faker.person.fullName();
//       const password = generateValidPassword();
//       const imgBase64 = generateBase64Image();
//       const imgPath = path.join(buildDir, `img${i}.jpg`);
//       fs.writeFileSync(imgPath, imgBase64, { encoding: 'base64' });
